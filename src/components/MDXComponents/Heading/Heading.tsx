...
export default function Heading({
  ...
  return (
    ...
    >
      <a
        href={`#${id}`}
        className="absolute -left-6 top-1/2 translate-x-2 -translate-y-1/2 opacity-0 transition group-hover:translate-x-0 group-hover:opacity-100"
      >
...
export const H1 = (props: HeadingProps) => (
  <Heading {...props} level={1} className={clsx("mdx-heading group")} />
);
export const H2 = (props: HeadingProps) => (
  <Heading {...props} level={2} className={clsx("mdx-heading group")} />
);
export const H3 = (props: HeadingProps) => (
  <Heading {...props} level={3} className={clsx("mdx-heading group")} />
);
export const H4 = (props: HeadingProps) => (
  <Heading {...props} level={4} className={clsx("mdx-heading group")} />
);
export const H5 = (props: HeadingProps) => (
  <Heading {...props} level={5} className={clsx("mdx-heading group")} />
);
export const H6 = (props: HeadingProps) => (
  <Heading {...props} level={6} className={clsx("mdx-heading group")} />
);

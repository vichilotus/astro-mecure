...
const TimelineItem = forwardRef<HTMLDivElement, TimelineItemProps>(
  ({ className, label, icon, lineVariant, children, ...rest }, ref) => {
    return (
      <div
        ref={ref}
        className={twMerge(
        ...
        {...rest}
      >
        <div className={twMerge("h-8 leading-8 relative  font-semibold")}>
          <div
            className={twMerge(
...
const Timeline = forwardRef<HTMLDivElement, TimelineProps>(
  ({ className, children, ...rest }, ref) => {
    return (
      <div ref={ref} className={twMerge("pl-3", className)} {...rest}>
        {children}
      </div>
    );
  },

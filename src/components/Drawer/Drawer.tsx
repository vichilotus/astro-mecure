...
function DrawerContent({ children, className, ...rest }: DrawerContentProps) {
  return (
    <Dialog.Portal>
      <Dialog.Overlay
        className={twMerge(
...
function DrawerClose({ children, className, ...rest }: DrawerCloseProps) {
  return (
    <Dialog.Close
      className={twMerge(
...
function Drawer({ children, open, onOpenChange, ...rest }: DrawerProps) {
  return (
